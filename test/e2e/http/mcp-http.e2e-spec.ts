...
describe('MCP Streamable HTTP (E2E)', () => {
  ...
  describe('prompts', () => {
    // Skipped: prompts/get may return streaming format that mcpRequest does not parse correctly
    it.skip('should get create-module prompt', async () => {
      const result = (await mcpRequest(baseUrl, sessionId, 'prompts/get', {
        name: 'create-module',
        arguments: {
          moduleName: 'billing',
          hasController: 'true',

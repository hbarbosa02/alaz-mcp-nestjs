...
export class OnboardingResource {
  ...
  @Resource({
    uri: 'alaz://onboarding',
    name: 'Onboarding',
    description: 'Aggregated onboarding guide for the projeto-X project',
  ...
  async getOnboarding(): Promise<string> {
    ...
    const sections: string[] = [
      '# Onboarding — projeto-X Project',
      '',
      '## Stack',
      'NestJS 11, PostgreSQL (MikroORM), Redis, BullMQ, Passport, Zod/nestjs-zod, CQRS',
      '',
    ];
